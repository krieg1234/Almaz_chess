namespace Almaz_chess
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //board.FillBoardByRandom(); --заполнить доску случайными фигурами

            board.FillBoardByDefault(); // заполнить доску, как в начале игры
            Piece target;
            target = board.GetPieceByCoordinate(3, 6); // выбрать фигуру
           
                board.ReplacePiece(target, 3, 5); // переместить фигуру
